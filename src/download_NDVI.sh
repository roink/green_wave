...
exit_with_error() {
    ...
    echo $1
    echo
    echo "https://data.lpdaac.earthdatacloud.nasa.gov/lp-prod-protected/MOD13C1.061/MOD13C1.A2011017.061.2021181172207/MOD13C1.A2011017.061.2021181172207.hdf"
    echo
    exit 1
}
...
prompt_credentials
  detect_app_approval() {
    approved=`curl -s -b "$cookiejar" -c "$cookiejar" -L --max-redirs 5 --netrc-file "$netrc" https://data.lpdaac.earthdatacloud.nasa.gov/lp-prod-protected/MOD13C1.061/MOD13C1.A2011017.061.2021181172207/MOD13C1.A2011017.061.2021181172207.hdf -w '\n%{http_code}' | tail  -1`
...
setup_auth_curl() {
    ...
    status=$(curl -s -z "$(date)" -w '\n%{http_code}' https://data.lpdaac.earthdatacloud.nasa.gov/lp-prod-protected/MOD13C1.061/MOD13C1.A2011017.061.2021181172207/MOD13C1.A2011017.061.2021181172207.hdf | tail -1)
